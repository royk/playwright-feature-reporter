  ...
  test.describe("Features", () => {
    ...
    test.describe('Markdown generation', () => {
      ...
      test.describe("Configuration", () => {
        test("oldResultsFile can be provided to create a diff", () => {
          ...
          const expectedJson = [{"title":"Feature title","transparent":false,"suites":[],"tests":[{"title":"case title","status":"passed","change":"added"}],"change":"added"}];
